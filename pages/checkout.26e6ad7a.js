...
})({"aVPfW":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "1ad2b34826e6ad7a";
"use strict";
...
},{}],"cdwRK":[function(require,module,exports) {
...
function getListFromLS() {
    ...
    if (cartItems.length < 1) {
        let cartTag = document.getElementById("cart-container");
        cartTag.innerHTML = "Din varukorg \xe4r tom";
        let aTag = document.createElement("a");
        aTag.href = "products.html";
        aTag.innerHTML = " Tillbaka till produkter";
        cartTag.appendChild(aTag);
    } else shoppingCartHtml(cartItems);
}
...
function chooseCard() {
    ...
    let billCont = document.getElementById("bill");
    billCont.innerHTML = " ";
    cardForm.innerHTML = "";
    cardForm.classList.add("forms");
    let nameCard = document.createElement("input");
    ...
    nameCard.setAttribute("placeholder", "F\xf6rnamn och Efternamn");
    let numberCard = document.createElement("input");
    ...
    let dateCard = document.createElement("input");
    ...
    dateCard.setAttribute("placeholder", "MM/\xc5\xc5");
    let cvcCard = document.createElement("input");
    ...
    submit.setAttribute("value", "Slutf\xf6r k\xf6p");
    ...
    cardForm.addEventListener("submit", (e)=>{
        e.preventDefault();
        doneHtml();
        console.log("tack f\xf6r ditt k\xf6p");
    });
}
function choosePayment() {
    let radioOne = document.getElementById("card");
    radioOne.addEventListener("change", ()=>{
        chooseCard();
    });
    let bill = document.getElementById("faktura");
...
function billForm() {
    let cardForm = document.getElementById("cardCont");
    cardForm.innerHTML = "";
    let billCont = document.getElementById("bill");
    billCont.innerHTML = "";
    ...
    inputName.setAttribute("placeholder", "F\xf6rnamn och Efternamn");
    //pcode number
...
function doneHtml() {
    ...
    hTag.innerText = "Tack f\xf6r ditt k\xf6p!";
    localStorage.clear();
...
},{}]},["aVPfW","cdwRK"], "cdwRK", "parcelRequire94c2")

//# sourceMappingURL=checkout.26e6ad7a.js.map
